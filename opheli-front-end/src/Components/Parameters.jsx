                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" className="form-control" id="nom" name="nom" required value={user.Nom}/></td>
                            </tr>
                            <tr>
                                <td><label htmlFor="prenom">Prénom : </label></td>
                                <td><input type="text" className="form-control" id="prenom" name="prenom" required value={user.Prenom}/></td>
                            </tr>
                            <tr>
                                <td><label htmlFor="mail">Mail : </label></td>
                                <td><input type="mail" className="form-control" id="mail" name="mail" required value={user.Mail}/></td>
                            </tr>
                            <tr>
